...
export default function AdminRestaurantsPage() {
  ...
  const handleDeleteMenu = async (restaurantId: string, itemId: string) => {
    try {
      await api.delete(`/restaurants/${restaurantId}/menu`, {
        data: { itemId },
      })
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-8">
        <h1 className="text-3xl font-bold mb-8">Kelola Restoran</h1>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Create Restaurant */}
          <Card>
            <CardHeader>
              <CardTitle>Buat Restoran</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleCreateRestaurant}>Simpan</Button>
            </CardContent>
          </Card>
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              <CardTitle>Tambah Menu ke Restoran</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <Button onClick={handleAddMenu} disabled={!selectedRestaurant}>
                Tambah Menu
              </Button>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold">Daftar Restoran</h2>
          {loading ? (
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <div className="flex gap-2 shrink-0">
                        {editingRestaurantId === r._id ? (
                          <>
                            <Button size="sm" onClick={() => handleUpdateRestaurant(r._id)}>Simpan</Button>
                          ...
                          {editingMenu && editingMenu.restaurantId === r._id && editingMenu.itemId === m._id ? (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 w-full">
                              ...
                              <div className="flex gap-2 col-span-full">
                                <Button size="sm" onClick={handleUpdateMenu}>Simpan</Button>
